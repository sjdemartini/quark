...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_event', (
            ...
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base_tbp.OfficerPosition'])),
            ...
            ('project_report', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='event', null=True, blank=True, to=orm['project_reports.ProjectReport'])),
        ...
        db.create_table(u'events_eventsignup', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ...
        # Adding unique constraint on 'EventAttendance', fields ['event', 'person']
        db.create_unique(u'events_eventattendance', ['event_id', 'person_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventAttendance', fields ['event', 'person']
        db.delete_unique(u'events_eventattendance', ['event_id', 'person_id'])
    ...
    models = {
        ...
        u'events.eventattendance': {
            'Meta': {'unique_together': "(('event', 'person'),)", 'object_name': 'EventAttendance'},
        ...
        u'events.eventsignup': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
