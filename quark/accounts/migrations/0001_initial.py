...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIKey'
        db.create_table(u'accounts_apikey', (
        ...
        db.send_create_signal(u'accounts', ['APIKey'])


    def backwards(self, orm):
        # Deleting model 'APIKey'
        db.delete_table(u'accounts_apikey')
    ...
    models = {
        u'accounts.apikey': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'api_key'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
