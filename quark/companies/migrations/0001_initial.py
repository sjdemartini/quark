...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyRep'
        db.create_table(u'companies_companyrep', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Company'])),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'companies', ['CompanyRep'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CompanyRep'
        db.delete_table(u'companies_companyrep')
    ...
    models = {
        ...
        u'companies.companyrep': {
            'Meta': {'object_name': 'CompanyRep'},
