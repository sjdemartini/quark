...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'minutes_minutes', (
            ...
            ('meeting_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
    ...
    models = {
        ...
        u'minutes.minutes': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'Minutes'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
