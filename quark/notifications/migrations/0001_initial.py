...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notifications_notification', (
            ...
            ('cleared', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal(u'notifications', ['Notification'])

        # Adding unique constraint on 'Notification', fields ['user', 'content_type', 'object_pk']
        db.create_unique(u'notifications_notification', ['user_id', 'content_type_id', 'object_pk'])


    def backwards(self, orm):
        # Removing unique constraint on 'Notification', fields ['user', 'content_type', 'object_pk']
        db.delete_unique(u'notifications_notification', ['user_id', 'content_type_id', 'object_pk'])
    ...
    models = {
        ...
        u'notifications.notification': {
            'Meta': {'unique_together': "(('user', 'content_type', 'object_pk'),)", 'object_name': 'Notification'},
            'cleared': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
