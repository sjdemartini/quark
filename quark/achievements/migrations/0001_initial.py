...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'achievements_achievement', (
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True, db_index=True)),
            ...
            ('sequence', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')()),
            ('goal', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('privacy', self.gf('django.db.models.fields.CharField')(default='public', max_length=8, db_index=True)),
            ('manual', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('repeatable', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('rank', self.gf('django.db.models.fields.FloatField')(default=0, db_index=True)),
            ('acquired_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('unacquired_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('icon_creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'achievements', ['Achievement'])

        # Adding model 'UserAchievement'
        db.create_table(u'achievements_userachievement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('achievement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['achievements.Achievement'])),
            ('acquired', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ...
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Term'], null=True, blank=True)),
            ('data', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('notified_user', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'achievements', ['UserAchievement'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'achievements_userachievement')


    models = {
        u'achievements.achievement': {
            'Meta': {'ordering': "('rank',)", 'object_name': 'Achievement'},
            'acquired_icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'icon_creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            ...
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '32', 'primary_key': 'True', 'db_index': 'True'}),
            'unacquired_icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'})
        },
        u'achievements.userachievement': {
            ...
            'data': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notified_user': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
