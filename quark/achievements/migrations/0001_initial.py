...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'achievements_achievement', (
            ...
            ('short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, db_index=True)),
            ...
            ('icon_filename', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
    ...
    models = {
        u'achievements.achievement': {
            ...
            'icon_filename': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
