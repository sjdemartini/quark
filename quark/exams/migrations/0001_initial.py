...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exams_instructorpermission', (
            ...
            ('permission_allowed', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'exams.instructorpermission': {
            ...
            'permission_allowed': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        }
    }
